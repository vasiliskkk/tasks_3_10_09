...
//        Person person = new Person("Иван", 15, "Мужской");
//        person.displayInfo();
//        person.newAge();
...
//        Manager manager = new Manager("Никита", 55, "Мужской", 100000);
//        Worker worker1 = new Worker("Анна", 26, "Женский", 70000);
//        Worker worker2 = new Worker("Кристина", 35, "Женский", 70000);
//
...
//        BankAccount account = new BankAccount(555995, 10000.0);
//
